...
void ASpaceCowNeedWaterPawn::NotifyHit(class UPrimitiveComponent* MyComp, class AActor* Other, class UPrimitiveComponent* OtherComp, bool bSelfMoved, FVector HitLocation, FVector HitNormal, FVector NormalImpulse, const FHitResult& Hit)
{
...
void ASpaceCowNeedWaterPawn::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
...
void ASpaceCowNeedWaterPawn::MoveUpInput(float Val)
{
...
void ASpaceCowNeedWaterPawn::MoveRightInput(float Val)
{
